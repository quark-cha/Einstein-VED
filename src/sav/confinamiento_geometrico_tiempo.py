# LAS 6 GRÁFICAS COMPLETAS DEL CONCEPTO EINSTEIN-VED
import numpy as np
...
def grafica1_n1_fundamental():
    ...
    plt.tight_layout()
    plt.savefig('1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica2_n3_excitado():
    ...
    plt.tight_layout()
    plt.savefig('2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica3_comparacion():
    ...
    plt.tight_layout()
    plt.savefig('3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica4_generacion_dt_n1():
    ...
    plt.tight_layout()
    plt.savefig('4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica5_generacion_dt_n3():
    ...
    plt.tight_layout()
    plt.savefig('5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica6_evolucion_temporal():
    ...
    plt.tight_layout()
    plt.savefig('6_evolucion_temporal.svg', bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
