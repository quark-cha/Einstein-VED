...
ax1.legend()
plt.savefig('figura_1_proton.png', dpi=300)
plt.show()
plt.close()
...
plt.legend()
plt.savefig('figura_2.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig('figura_3_G_diana_3sigma.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig('figura_4_G_diana_4sigma.png', dpi=300)
plt.show()
plt.close()
...
plt.legend()
plt.savefig('figura_5_G_asintotica_log.png', dpi=300)
plt.show()
plt.close()
...
rect = Rectangle((x, y), width, height, 
                 linewidth=3, edgecolor='#8B8000', facecolor='none',
...
plt.tight_layout()
plt.savefig("figura_7_tabla_n2.png", dpi=300, bbox_inches='tight')
plt.show()
plt.close()

# ===========================
# 10. Figura 8: Conceptual – Materia como onda confinada sobre un holograma
# ===========================
...
plt.savefig("figura_8_materia_holograma.png", dpi=300)
plt.show()
plt.close()
...
plt.savefig('figura_9_proton_electron.png', dpi=300, bbox_inches='tight')
plt.show()



# ===========================
# 12. Figura 10: Tabla conceptual VED vs Schwarzschild
# ===========================
plt.figure(10, figsize=(14, 6))  # Aumentado el ancho
ax10 = plt.gca()
ax10.axis('off')
...
plt.tight_layout()
plt.savefig('figura_10_tabla_conceptual.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()