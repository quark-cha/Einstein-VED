...
def grafica1_n1_fundamental():
    """n=1: أنبوب الزمكان الأملس + موجة دائرية أساسية"""
    ...
    ax.set_title('الحالة الأساسية n=1\nالزمكان + موجة دائرية', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AR_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    """n=3: تنوع الزمكان + موجة بثلاث عقد"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('الحالة المثارة n=3\nتنوع الزمكان + 3 عقد', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AR_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    """مقارنة جنبًا إلى جنب n=1 مقابل n=3"""
    ...
    ax1.set_title('n=1: الحالة الأساسية', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: الحالة المثارة', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AR_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    """يعرض كيف تولد منحنيات dt السطح n=1"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('الإنشاء n=1: dt → السطح\nالمنحنيات الدائرية تولد أسطوانة', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AR_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    """يعرض كيف تولد منحنيات dt السطح n=3"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('الإنشاء n=3: dt → التنوع\nالمنحنيات ذات العقد تولد الهندسة', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AR_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
# =============================================================================
def grafica6_evolucion_الزمني():
    """التطور الكامل لـ dt عبر δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'التطور\nالزمني', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('التطور الكامل: dt → δt → الحالات n\nالحصر الكمي أينشتاين-VED', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AR_6_evolucion_الزمني.svg', bbox_inches='tight', dpi=300, facecolor='white')
    
    plt.close()
    print("✅ 6_evolucion_الزمني.svg")

# =============================================================================
# EJECUTAR LAS 6 GRÁFICAS
# =============================================================================
def main_6_graficas():
    print("🎨 جاري إنشاء 6 الرسوم الكاملة أينشتاين-VED...")
    ...
    grafica6_evolucion_الزمني()
    
    print("\n✅ الرسوم الكاملة الستة:")
    print("   1. 1_n1_fundamental.svg - الحالة الأساسية")
    print("   2. 2_n3_excitado.svg - الحالة المثارة") 
    print("   3. 3_comparacion_n1_n3.svg - المقارنة")
    print("   4. 4_generacion_dt_n1.svg - الإنشاء n=1")
    print("   5. 5_generacion_dt_n3.svg - الإنشاء n=3")
    print("   6. 6_evolucion_الزمني.svg - Evolución completa")
