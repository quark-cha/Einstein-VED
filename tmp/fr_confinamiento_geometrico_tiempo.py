...
def grafica1_n1_fundamental():
    """n=1: Tube espace-temps lisse + onde circulaire fondamentale"""
    ...
    ax.set_title('ÉTAT FONDAMENTAL n=1\nEspace-Temps + Onde Circulaire', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\FR_1_n1_fundamental.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica2_n3_excitado():
    """n=3: Variété espace-temps + onde avec 3 nœuds"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ÉTAT EXCITÉ n=3\nVariété Espace-Temps + 3 Nœuds', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\FR_2_n3_excitado.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica3_comparacion():
    """Comparaison côte à côte n=1 vs n=3"""
    ...
    ax1.set_title('n=1: État Fondamental', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: État Excité', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\FR_3_comparacion_n1_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica4_generacion_dt_n1():
    """Montre comment les courbes dt génèrent la surface n=1"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GÉNÉRATION n=1: dt → Surface\nCourbes Circulaires Génèrent Cylindre', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\FR_4_generacion_dt_n1.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica5_generacion_dt_n3():
    """Montre comment les courbes dt génèrent la surface n=3"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GÉNÉRATION n=3: dt → Variété\nCourbes avec Nœuds Génèrent Géométrie', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\FR_5_generacion_dt_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica6_evolucion_temporal():
    """Évolution complète dt à travers δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'Évolution\ntemporelle', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('ÉVOLUTION COMPLÈTE: dt → δt → États n\nConfinement Quantique Einstein-VED', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\FR_6_evolucion_temporal.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
# =============================================================================
def main_6_graficas():
    print("🎨 GÉNÉRATION DES 6 GRAPHIQUES COMPLETS EINSTEIN-VED...")
