...
def grafica1_n1_fundamental():
    """n=1: Tubo spaziotempo liscio + onda circolare fondamentale"""
    ...
    ax.set_title('STATO FONDAMENTALE n=1\nSpaziotempo + Onda Circolare', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\IT_1_n1_fundamental.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica2_n3_excitado():
    """n=3: Varietà spaziotempo + onda con 3 nodi"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('STATO ECCITATO n=3\nVarietà Spaziotempo + 3 Nodi', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\IT_2_n3_excitado.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica3_comparacion():
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\IT_3_comparacion_n1_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica4_generacion_dt_n1():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERAZIONE n=1: dt → Superficie\nCurve Circolari Generano Cilindro', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\IT_4_generacion_dt_n1.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica5_generacion_dt_n3():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERAZIONE n=3: dt → Varietà\nCurve con Nodi Generano Geometria', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\IT_5_generacion_dt_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica6_evolucion_temporal():
    """Evoluzione completa dt attraverso δt"""
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\IT_6_evolucion_temporal.svg", bbox_inches='tight', dpi=300, facecolor='white')
