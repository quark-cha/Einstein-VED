...
def grafica1_n1_fundamental():
    """n=1: Tubo spazio-tempo liscio + onda circolare fondamentale"""
    ...
    ax.set_title('STATO FONDAMENTALE n=1\nSpazio-Tempo + Onda Circolare', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\IT_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    """n=3: Varietà spazio-tempo + onda con 3 nodi"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('STATO ECCITATO n=3\nVarietà Spazio-Tempo + 3 Nodi', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\IT_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    """Confronto affiancato n=1 vs n=3"""
    ...
    ax1.set_title('n=1: Stato fondamentale', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: Stato eccitato', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\IT_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    """Mostra come le curve dt generano la superficie n=1"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERAZIONE n=1: dt → Superficie\nLe curve circolari generano un cilindro', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\IT_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    """Mostra come le curve dt generano la superficie n=3"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERAZIONE n=3: dt → Varietà\nLe curve con nodi generano la geometria', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\IT_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
# =============================================================================
def grafica6_evolucion_temporale():
    """Evoluzione completa di dt attraverso δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'Evoluzione\ntemporale', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('EVOLUZIONE COMPLETA: dt → δt → Stati n\nConfinamento Quantistico Einstein-VED', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\IT_6_evolucion_temporale.svg', bbox_inches='tight', dpi=300, facecolor='white')
    
    plt.close()
    print("✅ 6_evolucion_temporale.svg")

# =============================================================================
# EJECUTAR LAS 6 GRÁFICAS
# =============================================================================
def main_6_graficas():
    print("🎨 GENERAZIONE DEI 6 GRAFICI COMPLETI EINSTEIN-VED...")
    ...
    grafica6_evolucion_temporale()
    
    print("\n✅ I 6 GRAFICI COMPLETI:")
    print("   1. 1_n1_fundamental.svg - Stato base")
    print("   2. 2_n3_excited.svg - Stato eccitato") 
    print("   3. 3_comparacion_n1_n3.svg - Confronto")
    print("   4. 4_generacion_dt_n1.svg - Generazione n=1")
    print("   5. 5_generacion_dt_n3.svg - Generazione n=3")
    print("   6. 6_evolucion_temporale.svg - Evolución completa")
