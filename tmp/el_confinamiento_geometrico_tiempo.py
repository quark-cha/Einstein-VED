...
def grafica1_n1_fundamental():
    """n=1: Ομαλός σωλήνας χωροχρόνου + βασικό κυκλικό κύμα"""
    ...
    ax.set_title('ΒΑΣΙΚΗ ΚΑΤΑΣΤΑΣΗ n=1\nΧωροχρόνος + Κυκλικό Κύμα', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EL_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    """n=3: Ποικιλία χωροχρόνου + κύμα με 3 κόμβους"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ΔΙΕΓΕΡΜΕΝΗ ΚΑΤΑΣΤΑΣΗ n=3\nΠοικιλία Χωροχρόνου + 3 Κόμβοι', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EL_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    """Σύγκριση δίπλα-δίπλα n=1 vs n=3"""
    ...
    ax1.set_title('n=1: Βασική Κατάσταση', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: Διεγερμένη Κατάσταση', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EL_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    """Δείχνει πώς οι καμπύλες dt δημιουργούν την επιφάνεια n=1"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ΔΗΜΙΟΥΡΓΙΑ n=1: dt → Επιφάνεια\nΚυκλικές Καμπύλες Δημιουργούν Κύλινδρο', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EL_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    """Δείχνει πώς οι καμπύλες dt δημιουργούν την επιφάνεια n=3"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ΔΗΜΙΟΥΡΓΙΑ n=3: dt → Ποικιλία\nΚαμπύλες με Κόμβους Δημιουργούν Γεωμετρία', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EL_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
# =============================================================================
def grafica6_evolucion_Εξέλιξη():
    """Πλήρης εξέλιξη dt μέσω δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'Χρονική\nΕξέλιξη', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('ΠΛΗΡΗΣ ΕΞΕΛΙΞΗ: dt → δt → Καταστάσεις n\nΚβαντικός Περιορισμός Einstein-VED', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EL_6_evolucion_Εξέλιξη.svg', bbox_inches='tight', dpi=300, facecolor='white')
    
    plt.close()
    print("✅ 6_evolucion_Εξέλιξη.svg")

# =============================================================================
# EJECUTAR LAS 6 GRÁFICAS
# =============================================================================
def main_6_graficas():
    print("🎨 ΔΗΜΙΟΥΡΓΙΑ 6 ΠΛΗΡΩΝ ΔΙΑΓΡΑΜΜΑΤΩΝ EINSTEIN-VED...")
    ...
    grafica6_evolucion_Εξέλιξη()
    
    print("\n✅ ΤΑ 6 ΠΛΗΡΗ ΔΙΑΓΡΑΜΜΑΤΑ:")
    print("   1. 1_n1_fundamental.svg - Βασική κατάσταση")
    print("   2. 2_n3_excited.svg - Διεγερμένη κατάσταση") 
    print("   3. 3_comparacion_n1_n3.svg - Σύγκριση")
    print("   4. 4_generacion_dt_n1.svg - Δημιουργία n=1")
    print("   5. 5_generacion_dt_n3.svg - Δημιουργία n=3")
    print("   6. 6_evolucion_Εξέλιξη.svg - Evolución completa")
