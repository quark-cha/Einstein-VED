...
def grafica1_n1_fundamental():
    """n=1: Tubu espaciu-tempu lisu + onda circular fundamental"""
    ...
    ax.set_title('ESTÁU FUNDAMENTAL n=1\nEspaciu-Tempu + Onda Circular', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AST_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    """n=3: Variedá espaciu-tempu + onda con 3 nodos"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ESTÁU EXCITÁU n=3\nVariedá Espaciu-Tempu + 3 Nodos', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AST_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    ...
    ax1.set_title('n=1: Estáu Fundamental', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: Estáu Excitáu', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AST_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    """Amuestra cómo les curvas dt xeneren la superficie n=1"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('XENERACIÓN n=1: dt → Superficie\nCurves Circulares Xeneren Cilindru', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AST_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    """Amuestra cómo les curvas dt xeneren la superficie n=3"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('XENERACIÓN n=3: dt → Variedá\nCurves con Nodos Xeneren Xeometría', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AST_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica6_evolucion_temporal():
    """Evolución completa dt a traviés de δt"""
    ...
    ax.set_title('EVOLUCIÓN COMPLETA: dt → δt → Estáus n\nConfinamientu Cuánticu Einstein-VED', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\AST_6_evolucion_temporal.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
# =============================================================================
def main_6_graficas():
    print("🎨 XENERANDO LOS 6 GRÁFICOS COMPLETOS EINSTEIN-VED...")
    ...
    print("\n✅ LOS 6 GRÁFICOS COMPLETOS:")
    print("   1. 1_n1_fundamental.svg - Estáu base")
    print("   2. 2_n3_excitado.svg - Estáu excitáu") 
    print("   3. 3_comparacion_n1_n3.svg - Comparación")
    print("   4. 4_generacion_dt_n1.svg - Xeneración n=1")
    print("   5. 5_generacion_dt_n3.svg - Xeneración n=3")
