...
def grafica1_n1_fundamental():
    ...
    ax.set_title('基底状態 n=1\n時空＋円形波', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\JA_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('励起状態 n=3\n時空多様体＋3ノード', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\JA_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    ...
    ax1.set_title('n=1：基底状態', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3：励起状態', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\JA_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('生成 n=1：dt → 表面\n円形曲線が円柱を生成', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\JA_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('生成 n=3：dt → 多様体\nノードを持つ曲線が幾何学を生成', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\JA_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica6_evolucion_進化():
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, '時間的\n進化', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('完全進化：dt → δt → n 状態\nアインシュタイン-VED 量子閉じ込め', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\JA_6_evolucion_進化.svg', bbox_inches='tight', dpi=300, facecolor='white')
    
    plt.close()
    print("✅ 6_evolucion_進化.svg")

# =============================================================================
# EJECUTAR LAS 6 GRÁFICAS
# =============================================================================
def main_6_graficas():
    print("🎨 EINSTEIN-VED の 6 つの完全なグラフを生成中...")
    ...
    grafica6_evolucion_進化()
    
    print("\n✅ 6 つの完全なグラフ：")
    print("   1. 1_n1_fundamental.svg - 基底状態")
    print("   2. 2_n3_excited.svg - 励起状態") 
    print("   3. 3_comparacion_n1_n3.svg - 比較")
    print("   4. 4_generacion_dt_n1.svg - 生成 n=1")
    print("   5. 5_generacion_dt_n3.svg - 生成 n=3")
    print("   6. 6_evolucion_進化.svg - Evolución completa")
