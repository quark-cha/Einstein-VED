...
def grafica1_n1_fundamental():
    """n=1: Smooth space-time tube + fundamental circular wave"""
    ...
    ax.set_title('FUNDAMENTAL STATE n=1\nSpace-Time + Circular Wave', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EN_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    """n=3: Space-time manifold + wave with 3 nodes"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('EXCITED STATE n=3\nSpace-Time Manifold + 3 Nodes', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EN_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    """Side-by-side comparison n=1 vs n=3"""
    ...
    ax1.set_title('n=1: Fundamental State', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: Excited State', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EN_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    """Shows how dt curves generate the n=1 surface"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERATION n=1: dt → Surface\nCircular Curves Generate Cylinder', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EN_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    """Shows how dt curves generate the n=3 surface"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERATION n=3: dt → Manifold\nCurves with Nodes Generate Geometry', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EN_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
# =============================================================================
def grafica6_evolucion_Evolution():
    """Complete dt evolution through δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'Temporal\nEvolution', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('COMPLETE EVOLUTION: dt → δt → n States\nEinstein-VED Quantum Confinement', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\EN_6_evolucion_Evolution.svg', bbox_inches='tight', dpi=300, facecolor='white')
    
    plt.close()
    print("✅ 6_evolucion_Evolution.svg")

# =============================================================================
# EJECUTAR LAS 6 GRÁFICAS
# =============================================================================
def main_6_graficas():
    print("🎨 GENERATING THE 6 COMPLETE EINSTEIN-VED GRAPHS...")
    ...
    grafica6_evolucion_Evolution()
    
    print("\n✅ THE 6 COMPLETE GRAPHS:")
    print("   1. 1_n1_fundamental.svg - Base state")
    print("   2. 2_n3_excited.svg - Excited state") 
    print("   3. 3_comparison_n1_n3.svg - Comparison")
    print("   4. 4_generation_dt_n1.svg - Generation n=1")
    print("   5. 5_generation_dt_n3.svg - Generation n=3")
    print("   6. 6_evolucion_Evolution.svg - Evolución completa")
