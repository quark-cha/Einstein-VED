...
def calcular_rango_3sigma(mean, sigma):
    """Calcule la plage ±3σ pour la visualisation"""
...
def crear_grafica_doble_escala_corregida():
    ...
    ax.set_xticklabels(['Mécanique Quantique', 'LHC Expérimental', 'Einstein-VED'], rotation=15)
    ax.set_ylabel('Rayon du Proton (fm)', fontweight='bold')
    ax.set_title('Estimations du Rayon du Proton\navec Plages ±3σ', fontweight='bold', fontsize=14)
    ...
    texto_ved = textwrap.fill(
        "Einstein-VED: Déterministe geometric model of proton. \n" +
        "Rayon dérivé de 4 longueurs d'onde de confinement.", width=40
    )
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\FR_proton_doble_escala_corregida.svg", format='svg', dpi=300)
