...
def grafica1_n1_fundamental():
    """n=1: Glatte Raumzeit-Röhre + fundamentale Kreiswelle"""
    ...
    ax.set_title('GRUNDZUSTAND n=1\nRaumzeit + Kreiswelle', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\DE_1_n1_fundamental.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica2_n3_excitado():
    """n=3: Raumzeit-Mannigfaltigkeit + Welle mit 3 Knoten"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ANGEREGTER ZUSTAND n=3\nRaumzeit-Mannigfaltigkeit + 3 Knoten', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\DE_2_n3_excitado.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica3_comparacion():
    ...
    ax1.set_title('n=1: Grundzustand', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: Angeregter Zustand', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\DE_3_comparacion_n1_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica4_generacion_dt_n1():
    """Zeigt wie dt-Kurven die Oberfläche n=1 erzeugen"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ERZEUGUNG n=1: dt → Oberfläche\nKreisförmige Kurven erzeugen Zylinder', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\DE_4_generacion_dt_n1.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica5_generacion_dt_n3():
    """Zeigt wie dt-Kurven die Oberfläche n=3 erzeugen"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ERZEUGUNG n=3: dt → Mannigfaltigkeit\nKurven mit Knoten erzeugen Geometrie', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\DE_5_generacion_dt_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica6_evolucion_temporal():
    """Vollständige Evolution dt durch δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'Zeitliche\nEvolution', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('VOLLSTÄNDIGE EVOLUTION: dt → δt → Zustände n\nEinstein-VED Quanten-Confinement', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\DE_6_evolucion_temporal.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
# =============================================================================
def main_6_graficas():
    print("🎨 ERZEUGUNG DER 6 VOLLSTÄNDIGEN EINSTEIN-VED GRAFIKEN...")
