...
def grafica1_n1_fundamental():
    ...
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\ZH_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('激发态 n=3\n时空流形 + 3 个节点', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\ZH_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    ...
    ax1.set_title('n=1：基态', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3：激发态', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\ZH_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    ...
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\ZH_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('生成 n=3：dt → 流形\n带节点的曲线生成几何结构', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\ZH_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica6_evolucion_演化():
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, '时间\n演化', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('完整演化：dt → δt → n 状态\n爱因斯坦-VED 量子束缚', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\ZH_6_evolucion_演化.svg', bbox_inches='tight', dpi=300, facecolor='white')
    
    plt.close()
    print("✅ 6_evolucion_演化.svg")

# =============================================================================
# EJECUTAR LAS 6 GRÁFICAS
# =============================================================================
def main_6_graficas():
    print("🎨 生成 6 个完整的 EINSTEIN-VED 图表...")
    ...
    grafica6_evolucion_演化()
    
    print("\n✅ 6 个完整图表：")
    print("   1. 1_n1_fundamental.svg - 基本状态")
    print("   2. 2_n3_excited.svg - 激发状态") 
    print("   3. 3_comparacion_n1_n3.svg - 比较")
    print("   4. 4_generacion_dt_n1.svg - 生成 n=1")
    print("   5. 5_generacion_dt_n3.svg - 生成 n=3")
    print("   6. 6_evolucion_演化.svg - Evolución completa")
