...
def crear_grafica_doble_escala_corregida():
    ...
    ax.set_xticklabels(['ميكانيكا الكم', 'LHC تجريبي', 'Einstein-VED'], rotation=15)
    ax.set_ylabel('نصف قطر البروتون (فيمتو متر)', fontweight='bold')
    ax.set_title('تقديرات نصف قطر البروتون\nمع نطاقات ±3σ', fontweight='bold', fontsize=14)
    ...
    texto_ved = textwrap.fill(
        "Einstein-VED: حتمي geometric model of proton. \n" +
        "نصف القطر مشتق من 4 أطوال موجية للحبس.", width=40
    )
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\DE_proton_doble_escala_corregida.svg", format='svg', dpi=300)
