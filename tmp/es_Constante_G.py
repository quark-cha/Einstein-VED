...
ax1.legend()
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_1_proton.png", dpi=300)
plt.close()

# ===========================
# 4. Figura 3: Agujero negro y superficie 2D
# ===========================
R_s = 2 * G_exp * M_BH / c**2

plt.figure(figsize=(6,6))
ax2 = plt.gca()
circle = plt.Circle((0,0), R_s, color='black', alpha=0.7, label='Agujero negro')
...
plt.legend()
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_2_proton.png", dpi=300)
plt.close()
...
plt.xlim(0,6)
plt.xlabel('n ∈ Z⁺')
plt.ylabel('G calculado [m^3/kg/s^2]')
plt.title('Figura 3: Diana de G ±3σ', pad=20)
plt.xticks(np.arange(0,6))
plt.grid(True)
plt.legend()
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_3_G_diana_3sigma.png", dpi=300)
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_4_G_diana_4sigma.png", dpi=300)
plt.close()
...
plt.legend()
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_5_G_asintotica_log.png", dpi=300)
plt.close()
...
plt.title("CONSTANTE GRAVITATORIA G", 
          fontsize=16, pad=20, weight='bold')

plt.tight_layout()
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_7_tabla_n2.png", dpi=300, bbox_inches='tight')
plt.close()
...
ax.set_title('Figura 8: Materia como onda confinada sobre holograma 2D', fontsize=14, pad=20)
ax.legend(loc='upper right', fontsize=10)
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_8_materia_holograma.png", dpi=300)
plt.close()
...
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_9_proton_electron.png", dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\ES_figura_10_tabla_conceptual.png", dpi=300, bbox_inches='tight')
plt.close()