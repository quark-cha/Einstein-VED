...
def grafica1_n1_fundamental():
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\1_n1_fundamental.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica2_n3_excitado():
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\2_n3_excitado.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica3_comparacion():
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\3_comparacion_n1_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica4_generacion_dt_n1():
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\4_generacion_dt_n1.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica5_generacion_dt_n3():
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\5_generacion_dt_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica6_evolucion_temporal():
    ...
    ax.set_title('完整演化: dt → δt → n状态\n爱因斯坦-VED量子约束', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\6_evolucion_temporal.svg", bbox_inches='tight', dpi=300, facecolor='white')
