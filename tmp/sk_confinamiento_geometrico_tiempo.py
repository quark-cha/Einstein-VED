...
def grafica1_n1_fundamental():
    """n=1: Hladká časopriestorová trubica + fundamentálna kruhová vlna"""
    ...
    ax.set_title('FUNDAMENTÁLNY STAV n=1\nČasopriestor + Kruhová vlna', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\SK_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    """n=3: Časopriestorová rozmanitosť + vlna s 3 uzlami"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('EXCITOVANÝ STAV n=3\nČasopriestorová rozmanitosť + 3 uzly', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\SK_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    """Porovnanie vedľa seba n=1 vs n=3"""
    ...
    ax1.set_title('n=1: Fundamentálny stav', fontweight='bold', pad=15)
    ...
    ax2.set_title('n=3: Excitovaný stav', fontweight='bold', pad=15)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\SK_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    """Ukazuje, ako krivky dt generujú plochu n=1"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERÁCIA n=1: dt → Plocha\nKruhové krivky generujú valec', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\SK_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    """Ukazuje, ako krivky dt generujú plochu n=3"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERÁCIA n=3: dt → Rozmanitosť\nKrivky s uzlami generujú geometriu', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\SK_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
# =============================================================================
def grafica6_evolucion_Evolúcia():
    """Kompletná evolúcia dt cez δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'Časová\nEvolúcia', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('KOMPLETNÁ EVOLÚCIA: dt → δt → Stavy n\nEinstein-VED Kvantové uzavretie', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\SK_6_evolucion_Evolúcia.svg', bbox_inches='tight', dpi=300, facecolor='white')
    
    plt.close()
    print("✅ 6_evolucion_Evolúcia.svg")

# =============================================================================
# EJECUTAR LAS 6 GRÁFICAS
# =============================================================================
def main_6_graficas():
    print("🎨 GENERUJÚ SA 6 KOMPLETNÝCH EINSTEIN-VED GRAFOV...")
    ...
    grafica6_evolucion_Evolúcia()
    
    print("\n✅ 6 KOMPLETNÝCH GRAFOV:")
    print("   1. 1_n1_fundamental.svg - Základný stav")
    print("   2. 2_n3_excited.svg - Excitovaný stav") 
    print("   3. 3_comparacion_n1_n3.svg - Porovnanie")
    print("   4. 4_generacion_dt_n1.svg - Generácia n=1")
    print("   5. 5_generacion_dt_n3.svg - Generácia n=3")
    print("   6. 6_evolucion_Evolúcia.svg - Evolución completa")
