...
def grafica1_n1_fundamental():
    """n=1: Hladká priestoročasová trubica + fundamentálna kruhová vlna"""
    ...
    ax.set_title('ZÁKLADNÝ STAV n=1\nPriestoročas + Kruhová vlna', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\SK_1_n1_fundamental.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica2_n3_excitado():
    """n=3: Priestoročasová varieta + vlna s 3 uzlami"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('EXCITOVANÝ STAV n=3\nPriestoročasová Varieta + 3 Uzly', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\SK_2_n3_excitado.svg", bbox_inches='tight', dpi=300, facecolor='white')
    plt.close()
...
def grafica3_comparacion():
    ...
    ax1.set_title('n=1: Základný stav', fontweight='bold', pad=15)
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\SK_3_comparacion_n1_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica4_generacion_dt_n1():
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\SK_4_generacion_dt_n1.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica5_generacion_dt_n3():
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GENERÁCIA n=3: dt → Varieta\nKrivky s uzlami generujú geometriu', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\SK_5_generacion_dt_n3.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica6_evolucion_temporal():
    ...
    ax.set_title('ÚPLNÁ EVOLÚCIA: dt → δt → Stavy n\nEinstein-VED Kvantové uväznenie', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig(r"C:\Users\vedq\Desktop\desarrollo\SRC-VED\Einstein-VED\img\SK_6_evolucion_temporal.svg", bbox_inches='tight', dpi=300, facecolor='white')
...
# =============================================================================
def main_6_graficas():
    print("🎨 GENEROVANIE 6 ÚPLNÝCH EINSTEIN-VED GRAFOV...")
