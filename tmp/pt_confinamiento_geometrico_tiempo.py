...
def grafica1_n1_fundamental():
    """n=1: Tubo espaço-tempo liso + onda circular fundamental"""
    ...
    ax.set_title('ESTADO FUNDAMENTAL n=1\nEspaço-Tempo + Onda Circular', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\PT_1_n1_fundamental.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
def grafica2_n3_excitado():
    """n=3: Variedade espaço-tempo + onda com 3 nós"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('ESTADO EXCITADO n=3\nVariedade Espaço-Tempo + 3 Nós', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\PT_2_n3_excitado.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
    plt.close()
...
def grafica3_comparacion():
    """Comparação lado a lado n=1 vs n=3"""
    ...
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\PT_3_comparacion_n1_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica4_generacion_dt_n1():
    """Mostra como as curvas dt geram a superfície n=1"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GERAÇÃO n=1: dt → Superfície\nCurvas Circulares Geram Cilindro', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\PT_4_generacion_dt_n1.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica5_generacion_dt_n3():
    """Mostra como as curvas dt geram a superfície n=3"""
    ...
    ax.set_axis_off()
    ax.view_init(elev=20, azim=-60)
    ax.set_title('GERAÇÃO n=3: dt → Variedade\nCurvas com Nós Geram Geometria', 
                fontweight='bold', pad=20, fontsize=12)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\PT_5_generacion_dt_n3.svg', bbox_inches='tight', dpi=300, facecolor='white')
    # plt.show()  # Desactivado en traducciones
...
def grafica6_evolucion_temporal():
    """Evolução completa dt através de δt"""
    ...
    ax.text(radio_base+0.7, 0, delta_t/2, 'Evolução\ntemporal', color='blue', fontweight='bold')
    
    ax.set_axis_off()
    ax.view_init(elev=25, azim=-50)
    ax.set_title('EVOLUÇÃO COMPLETA: dt → δt → Estados n\nConfinamento Quântico Einstein-VED', 
                fontweight='bold', pad=25, fontsize=14)
    
    plt.tight_layout()
    plt.savefig('C:\\Users\\vedq\\Desktop\\desarrollo\\SRC-VED\\Einstein-VED\\img\\PT_6_evolucion_temporal.svg', bbox_inches='tight', dpi=300, facecolor='white')
...
# =============================================================================
def main_6_graficas():
    print("🎨 GERANDO OS 6 GRÁFICOS COMPLETOS EINSTEIN-VED...")
    ...
    print("\n✅ OS 6 GRÁFICOS COMPLETOS:")
    print("   1. 1_n1_fundamental.svg - Estado base")
    print("   2. 2_n3_excitado.svg - Estado excitado") 
    print("   3. 3_comparacion_n1_n3.svg - Comparação")
    print("   4. 4_generacion_dt_n1.svg - Geração n=1")
    print("   5. 5_generacion_dt_n3.svg - Geração n=3")
    print("   6. 6_evolucion_temporal.svg - Evolução completa")
